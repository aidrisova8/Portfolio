...
const Home = () => {
  return (
    <div className='home-wrapper'>
        ...
        <h2>Software</h2> <h2>Testing</h2> <h2>Developer </h2> 
        </div>
        <p>Bringing Quality to Software Development with Automated Testing</p>  
        </div>
        </div>
...
<div className='about'>
    <h2>About Me</h2>
    <p>
    Hello! I'm Kamila Idris, a results-driven professional with a strong background in software development and extensive knowledge in both manual and automated software testing.
  </p>
  <p>
  ...
  <p>
    My front-end development skills include HTML5, CSS3, JavaScript, and React.js. Furthermore, I've developed server-side applications using Node.js and Express.js.
  </p> 
  <p>
  Feel free to explore my GitHub repositories at <a href="https://github.com/aidrisova8" target="_blank" rel="noopener noreferrer">GitHub</a>.
   Connect with me on <a href="https://www.linkedin.com/in/kamila-idris-64641029b/" target="_blank" rel="noopener noreferrer">LinkedIn</a>.
  </p>
</div>
        </div>
